...
<?php echo $this->Form->create('Major');?>
	<fieldset>
		<legend><?php echo __('Edit Major'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Major.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Major.id'))); ?></li>
