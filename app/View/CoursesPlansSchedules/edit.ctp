...
<?php echo $this->Form->create('CoursesPlansSchedule'); ?>
	<fieldset>
		<legend><?php echo __('Edit Courses Plans Schedule'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CoursesPlansSchedule.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CoursesPlansSchedule.id'))); ?></li>
